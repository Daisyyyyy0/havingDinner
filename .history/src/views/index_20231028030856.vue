           ...
           <section class="choice px-[4rem]">
            <div class="max-w-[1140px] relative flex flex-col justify-center items-center">
                ...
                <div class="mb-[4rem] flex justify-center items-center">
                    <a href="/check.html" class="border-[5px] border-[#BC7C96] border-solid ml-[20acc_btn flex">
                        <div class="img">
                    ...
                    <a href="/reservation-partner.html" class="border-[5px] border-[#E0AB77] border-solid ml-[20acc_btn flex">
                        <div class="img">
