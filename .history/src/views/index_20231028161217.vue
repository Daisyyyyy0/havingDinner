      ...
      <div class="w-full mx-auto px-[12px] 2xl:max-w-[1320px] xl:max-w-[1140px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px] mt-[80px] relative">
            <div class="flex flex-wrap">
               <div class="w-2/3 px-[12px] flex items-center text-center text-[24px]">
                  ...
                  <div class="news_context flex justify-center items-center bg-[rgb(239,196,196)]/50 h-[80%] w-full">
...
<style lang="scss" scoped>
   ...
   .information{
      .news_context{
         main #information .container1 .row .news .news-context .t tbody .row {
    color: white;
