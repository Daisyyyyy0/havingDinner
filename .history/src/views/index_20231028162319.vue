...
<template>
  ...
  <section class="belief pt-[4rem] pb-[8rem] flex justify-center items-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
   ...
   <section class="information py-[4rem] text-[#222] flex flex-col">
      <!-- rwd小於1300px -->
      <!-- <div class="w-full mx-auto px-[12px] min-[]:max-w-[1320px] xl:max-w-[1140px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px] container0">
            <div class="row">
      ...
      <div class="w-full mx-auto px-[12px] min-[]:max-w-[1320px] xl:max-w-[1140px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px] mt-[80px] relative">
      ...
      <div class="w-full mx-auto px-[12px] min-[]:max-w-[1320px] xl:max-w-[1140px] lg:max-w-[960px] md:max-w-[720px] sm:max-w-[540px] container2">
            <div class="row row2">
