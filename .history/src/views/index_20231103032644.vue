      ...
      <div class=" w-full mx-auto px-[12px] 2xl:max-w-[1320px] xl:max-w-[95%] lg:max-w-[90%] md:max-w-[720px] sm:max-w-[540px] mt-[80px] relative">
            <div class="flex flex-wrap">
               <div class="w-2/3 px-[12px] flex items-start text-center text-[24px] ">
                  <div class="flex items-center w-[90px] h-[100px] px-[10px]  absolute top-[-17.5%] left-[5%] font-bold bg-[#EEC7AE]">
                     最新消息
                  </div>
                  <div class="news_context py-[1rem] flex justify-center items-center bg-[rgb(239,196,196)]/40 w-full">
