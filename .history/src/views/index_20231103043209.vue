            ...
            <div class="flex flex-wrap max-w-full">
               <div class="rules w-1/3 px-[12px] flex text-[24px] font-bold">
                  <div class="relative flex flex-col justify-evenly">
                     <div class="aleft-[20px] bg-[#EEC7AE]/75 w-[65px] h-[100px] flex items-center time">搭伙時段</div>
                     <div class="aleft-[20px] bg-[#EEC7AE]/75 w-[65px] h-[100px] flex items-center price">收費標準</div>
                  </div>
