...
<template>
  ...
  <section class="belief pt-[4rem] pb-[8rem] flex justify-center items-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
   ...
   <section class="information py-[4rem] text-[#222] flex flex-col">
      <!-- rwd小於1300px -->
      <!-- <div class="2xl:max-w-[1320px] xl:max-w-[1140px] lg:max container0">
            <div class="row">
      ...
      <div class="2xl:max-w-[1320px] xl:max-w-[1140px] lg:max container1">
            <div class="row">
      ...
      <div class="2xl:max-w-[1320px] xl:max-w-[1140px] lg:max container2">
            <div class="row row2">
